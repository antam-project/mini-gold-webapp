    ...
    <section class="bg-white dark:bg-gray-900">
        <div class="grid py-8 px-4 mx-auto max-w-screen-xl lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
            <div class="place-self-center mr-auto lg:col-span-7">
                <h1 class="mb-4 max-w-2xl text-4xl font-extrabold leading-none md:text-5xl xl:text-6xl dark:text-white">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam eget metus enim.</h1>
                <p class="mb-6 max-w-2xl font-light text-gray-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400">Aliquam luctus magna a venenatis faucibus. Proin dignissim erat pharetra tempor consectetur. Vivamus hendrerit lectus at tincidunt ultrices. Nam at suscipit sapien.</p>
                <a href="#" class="inline-flex justify-center items-center py-3 px-5 text-base font-medium text-center text-gray-900 rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 dark:text-white dark:border-gray-700 dark:hover:bg-gray-700 dark:focus:ring-gray-800">
                    Check Now
                </a>
            </div>
            <div class="hidden lg:mt-0 lg:col-span-5 lg:flex">
                <img src="https://www.static-src.com/wcsstore/Indraprastha/images/catalog/full//93/MTA-3162972/antam_logam-mulia-1-gram_full03.jpg" alt="mockup">
            </div>
        </div>
    </section>
