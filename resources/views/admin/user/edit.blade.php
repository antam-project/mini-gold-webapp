            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="overflow-x-auto relative">
                        <header>
                            <h2 class="text-lg font-medium text-gray-900">Kelola Informasi Pengguna</h2>
                            <p class="mt-1 text-sm text-gray-600">Kelola Informasi Pengguna.</p>
                        </header>
        ...
        <div class=" mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    <div class="overflow-x-auto relative">
                        <header>
                            <h2 class="text-lg font-medium text-gray-900">Kelola Role Pengguna</h2>
                            <p class="mt-1 text-sm text-gray-600">Kelola Role Pengguna.</p>
                        </header>
                        <button
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    <form action="{{route('admin.user.role.add',$user->id)}}" method="post">
                        @csrf
                        <label for="roles" class="block mb-4 text-sm font-medium text-gray-900 dark:text-white">Pilih Role</label>
